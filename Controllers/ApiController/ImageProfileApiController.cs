...
public class ImageProfileApiController : Controller
{
    private readonly IWebHostEnvironment _env;
    private readonly SystemSchoolDbContext _context;
    private readonly INotyfService _notyf;

    public ImageProfileApiController(IWebHostEnvironment env, INotyfService notyf, SystemSchoolDbContext context)
    {
        _env = env;
        _context = context;
        _notyf = notyf;
