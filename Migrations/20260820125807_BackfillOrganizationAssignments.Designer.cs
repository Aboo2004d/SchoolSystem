...
namespace SchoolSystem.Migrations
{
    ...
    [Migration("20260820125807_BackfillOrganizationAssignments")]
    partial class BackfillOrganizationAssignments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolSystem.Data.Ministry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SchoolSystem.Data.MinistryManager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MinistryManager", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolSystem.Data.SchoolManagerAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ManagerId", "SchoolId")
                        .IsUnique()
                        .HasFilter("[IsActive] = 1");

                    b.ToTable("SchoolManagerAssignment", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolSystem.Data.StudentEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SchoolSystem.Data.TeacherLectuerClass", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdSchool", "IdClass", "IdLectuer" }, "UX_TeacherLectuer_ActiveSchoolClassSubject")
                        .IsUnique()
                        .HasFilter("[IsDeletedTeacherLectuerClass] = 0 AND [IsDeletedClass] = 0 AND [IsDeletedLectuer] = 0 AND [IsDeletedTeacher] = 0 AND [IsDeletedSchool] = 0");

                    b.ToTable("TeacherLectuerClass", (string)null);
                });

            modelBuilder.Entity("SchoolSystem.Data.TeacherPlacement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TeacherPlacement", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolSystem.Data.TransferRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DestinationClassId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DestinationDirectorateId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DestinationMinistryId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DestinationSchoolId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("SourceDirectorateId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("SourceMinistryId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("SourceSchoolId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("DestinationDirectorateId");

                    b.HasIndex("DestinationMinistryId");

                    b.HasIndex("SourceDirectorateId");
            ...
            modelBuilder.Entity("SchoolSystem.Data.Directorate", b =>
                {
                    b.HasOne("SchoolSystem.Data.Ministry", "Ministry")
            ...
            modelBuilder.Entity("SchoolSystem.Data.MinistryManager", b =>
                {
                    ...
                    b.HasOne("SchoolSystem.Data.Ministry", "Ministry")
                        .WithOne("Manager")
                        .HasForeignKey("SchoolSystem.Data.MinistryManager", "MinistryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SchoolSystem.Data.SchoolManagerAssignment", b =>
                {
                    b.HasOne("SchoolSystem.Data.Menegar", "Manager")
                        .WithMany("SchoolAssignments")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SchoolSystem.Data.School", "School")
            ...
            modelBuilder.Entity("SchoolSystem.Data.StudentEnrollment", b =>
                {
                    b.HasOne("SchoolSystem.Data.TheClass", "Class")
                        .WithMany()
                    ...
                    b.HasOne("SchoolSystem.Data.Student", "Student")
            ...
            modelBuilder.Entity("SchoolSystem.Data.TeacherPlacement", b =>
                {
                    b.HasOne("SchoolSystem.Data.School", "School")
                        .WithMany("TeacherPlacements")
                        .HasForeignKey("SchoolId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SchoolSystem.Data.Teacher", "Teacher")
                        .WithMany("Placements")
            ...
            modelBuilder.Entity("SchoolSystem.Data.School", b =>
                {
                    ...
                    b.Navigation("TeacherPlacements");
